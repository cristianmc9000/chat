...
if(!empty($_GET["room_id"])){
	...
	if(mysqli_num_rows($query) > 0){
		$room_data = mysqli_fetch_array($query) or error("No puedo obtener los datos");
	} else {
		error("eL iD NO EXISTE", $_HOME_FILE); //$_HOME_FILE --> /config/value.php
	}
}
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Cambiar el nombre del grupo y la descripcion</h5>
                        </div>
                        <div class="ibox-content">
							<form id="change_name_description" method="GET" action="chat.php" class="form-horizontal">
								<div class="form-group"><label class="col-sm-1 control-label">Nombre: </label>
