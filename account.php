							...
							<form id="change_picture" method="GET" action="chat.php" class="form-horizontal">
								...
								<div class="form-group">
									<div class="col-sm-4 col-sm-offset-1">
										<small><p>Serás baneado si usas una imagen/foto sensible.</p></small>
										<button id="cppbtn" class="btn btn-primary" name="submit" type="submit">
Cambiar</button>
									</div>
								</div>
							</form>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
							<form id="change_name" method="GET" action="chat.php" class="form-horizontal">
								<div class="form-group"><label class="col-sm-1 control-label">Primer Nombre</label>
									<div class="col-sm-10"><input type="text" name="firstName" value="<?= $user["firstName"]; ?>" class="form-control" autocomplete="off"></div>
								</div>
								
								<div class="form-group"><label class="col-sm-1 control-label">Apellido</label>
									<div class="col-sm-10"><input type="text" name="lastName" value="<?= $user["lastName"]; ?>" class="form-control" autocomplete="off"></div>
								</div>
								
								<div class="form-group">
									<div class="col-sm-4 col-sm-offset-1">
										<button id="cgnbtn" class="btn btn-primary" name="submit" type="submit">Cambiar</button>
									</div>
								</div>
							</form>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
							<form id="change_password" method="GET" action="chat.php" class="form-horizontal">
								<div class="form-group"><label class="col-sm-1 control-label">Contraseña actual</label>
									<div class="col-sm-10"><input type="password" name="cr_password" value="" class="form-control" autocomplete="off"></div>
								</div>
								
								<div class="form-group"><label class="col-sm-1 control-label">Nueva Contraseña</label>
									<div class="col-sm-10"><input type="password" name="nw_password" value="" class="form-control" autocomplete="off"></div>
								</div>
								
								<div class="form-group">
									<div class="col-sm-4 col-sm-offset-1">
										<button id="cgpbtn" class="btn btn-primary" name="submit" type="submit">Cambiar</button>
									</div>
								</div>
							</form>
