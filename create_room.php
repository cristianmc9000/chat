		...
		?>
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            <a href="create_room.php">Crear sala de chat</a>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Crear formulario de sala</h5>
                        </div>
                        <div class="ibox-content">
							<form id="create_form" class="form-horizontal">
								<div class="form-group"><label class="col-sm-1 control-label">Nombre de sala</label>
								...
								<div class="form-group">
									<div class="col-sm-4 col-sm-offset-1">
										<button id="create_button" class="btn btn-primary" value="submit" name="submit" type="submit">Crear sala</button>
									</div>
								</div>
							</form>
                        </div>
